...
. From the _Backup Settings page_, click image:screenshot_horizontal_more_button.gif[More icon] for the working environment, or the Kubernetes cluster, where you want to change the settings and select *Manage Policies*.
+
...
. From the _Manage Policies_ page, change the schedule and backup retention and then click *Save*.
+
