...
. Click the *Volumes* tab and the Volumes Backup Dashboard is displayed.
+
...
. From the Volumes Backup Dashboard, select *Backup Settings*.
+
...
. From the Volumes Backup Dashboard, click image:screenshot_horizontal_more_button.gif[More icon] for the volume and select *Backup Now*.
+
...
. From the Volumes Backup Dashboard, click image:screenshot_horizontal_more_button.gif[More icon] for the source volume and select *Details & Backup List*.
+
