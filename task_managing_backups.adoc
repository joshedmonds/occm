...
If you want to apply a new backup policy to certain volumes in a working environment, you first need to add the backup policy to the working environment. Then you can add the policy to volumes in that working environment.
...
You can change the backup policy assigned to your existing volumes.
...
. Select the checkbox for a volume, or volumes, that you want to change the policy, and then click *Change Policy*.
+
