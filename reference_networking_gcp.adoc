...
Outbound internet access is required from the Connector and from your web browser. The following sections identify the specific endpoints.
...
=== Endpoints accessed from your web browser when using the UI

The Cloud Manager user interface is accessible from a web browser. The machine running the web browser must have connections to the following endpoints.
...
| Required to deploy a Connector in AWS from Cloud Manager.

|
\https://management.azure.com
\https://login.microsoftonline.com
| Required to deploy a Connector in most Azure regions from Cloud Manager.

|
\https://management.microsoftazure.de
\https://login.microsoftonline.de
| Required to deploy a Connector in Azure Germany regions from Cloud Manager.

|
\https://management.usgovcloudapi.net
\https://login.microsoftonline.com
| Required to deploy a Connector in Azure US Gov regions from Cloud Manager.

|
\https://www.googleapis.com

| Required to deploy a Connector in Google Cloud from Cloud Manager.
