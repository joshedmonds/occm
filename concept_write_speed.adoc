...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_9100.html[Learn more about the Amazon EC2 instances that Cloud Volumes ONTAP supports^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_9100.html[Learn more about the Azure VM types that Cloud Volumes ONTAP supports^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_9100.html[Learn more about the Google Cloud machine types that Cloud Volumes ONTAP supports^].
