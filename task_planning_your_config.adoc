...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_9100.html[Supported configurations for Cloud Volumes ONTAP in AWS^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_9100.html[Storage limits for Cloud Volumes ONTAP in AWS^]
