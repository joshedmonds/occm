...
If you have any questions about the details required to create the working environment, see link:task_deploying_otc_aws.html[Launching Cloud Volumes ONTAP in AWS^].
