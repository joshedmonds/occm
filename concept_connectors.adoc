...
* link:task-install-connector-onprem-no-internet.html[By downloading and installing the software on an on-premises Linux host that doesn't have internet access]
