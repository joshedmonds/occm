...
* You can now provide a meaningful name to each of your sync relationships to more easily identify the purpose of each relationship.
+
...
* Box to Azure NetApp Files is now supported as a sync relationship.
+
link:reference_sync_requirements.html[View the list of supported sync relationships].
