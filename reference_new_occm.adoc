...
+
If your AKS cluster has NetApp Astra Trident installed, and it is using Cloud Volumes ONTAP for Azure as backend storage for the cluster, then you can back up and restore volumes to and from Azure Blob storage. link:task_backup_kubernetes_to_azure.html[Go here for details].
