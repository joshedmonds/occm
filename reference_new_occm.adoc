...
* We redesigned the licensing selection screen when creating a new Cloud Volumes ONTAP working environment. The changes highlight the new by-capacity charging methods and support upcoming offerings through the cloud provider marketplaces.
