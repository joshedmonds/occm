...
== Cloud Manager 3.9.15 update (8 Feb 2022)
...
+
These by-capacity charging methods enable you to pay by the hour or to purchase an annual contract directly from your cloud provider. You still have the option to purchase a license directly from NetApp.

* By-node licensing via the AWS and Google Cloud Marketplaces (Explore, Standard, and Premium) is deprecated and no longer available for new subscribers.
+
This charging method is still available for customers who have an active subscription.
...
* Cloud Sync is now integrated with Cloud Data Sense. From within Data Sense, you can select the source files that you’d like to sync to a target location using Cloud Sync.
+
