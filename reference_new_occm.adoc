...
== Cloud Manager <build_number> (15 October 2021)
...
link:overview-architecture-limitation-snapcenter-service.html[Learn about SnapCenter Service]

You should create an Azure Connector in Cloud Manager, enable SnapCenter Service, add SAP HANA systems, and then perform backup and restore operations.
