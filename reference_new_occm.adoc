...
* Discover Amazon EKS Kubernetes clusters
...
* You can now install the Connector on an on-premises Linux host that doesn’t have internet access and then discover on-prem ONTAP clusters, replicate data between them, and scan them with Cloud Data Sense.
+
