...
* Data Sense can automatically delete files that match the query that you define in a Policy. link:task_managing_highlights.html#controlling-your-data-using-policies[See how to create custom Policies].
