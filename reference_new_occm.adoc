...
=== SnapCenter Service enhancements (21 Dec)

The SnapCenter Service 1.0.1 release contains security fixes for Log4j vulnerabilities.

SnapCenter Service 1.0 uses Log4j 2.9.1 and is vulnerable to Log4j security threats. In SnapCenter Service 1.0.1, the Log4j version 2.17 is being used. The following CVEs are addressed in the release: CVE-2021-44228, CVE-2021-4104, and CVE-2021-45105.

By default, the SnapCenter Service cluster is upgraded to the latest version. You should ensure that the version of the SnapCenter Service cluster is 1.0.1.1251 or later.
