...
== Cloud Manager 3.9.11 build2 (15 Oct 2021)
...
* You should create an Azure Connector, enable SnapCenter Service, add SAP HANA systems, and then perform backup and restore operations.
+
