...
This update provides support for Cloud Manager and Cloud Data Sense to be deployed in an on-premises site that doesn’t have internet access. Now your secure sites can use Cloud Manager to manage your on-prem ONTAP clusters, and Cloud Data Sense to scan data from those on-premises ONTAP systems and any locally installed databases.
