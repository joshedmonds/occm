...
= Requirements for Kubernetes clusters in Amazon
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
You can add a managed Amazon Elastic Kubernetes Service (Amazon EKS) clusters or self-managed Kubernetes clusters in Amazon to Cloud Manager. Before you can add the clusters to Cloud Manager, you need to ensure that the following requirements are met.
