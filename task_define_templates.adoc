...
.. When replicating a volume to a Cloud Volumes ONTAP cluster (not to an on-prem ONTAP cluster), you can specify whether volume tiering is enabled on the destination volume.
