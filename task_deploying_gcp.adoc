...
a|
. Contact NetApp to authorize your user account to one or more Keystone Flex Subscriptions.
. After NetApp authorizes your account, link your subscriptions for use with Cloud Volumes ONTAP.
