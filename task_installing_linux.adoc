...
.AWS
--
link:task_adding_aws_accounts.html[Set up an AWS account and then add it to Cloud Manager].
--

.Azure
--
link:task_adding_azure_accounts.html[Set up an Azure account and then add it to Cloud Manager].
--
