...
==== New permissions to discover GKE clusters

The following permissions are now required to discover Kubernetes clusters running in Google Kubernetes Engine:
