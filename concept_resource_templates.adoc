...
* Create a Cloud Volumes ONTAP working environment (single node system on AWS)
* Find an existing resources that meet certain criteria (so you can apply a "services" action on exiting resources)
