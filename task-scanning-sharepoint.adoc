...
Ensure that you have the Admin credentials to log into the SharePoint account.
...
[role="quick-margin-para"]
Add the list of SharePoint site URLs that you want to scan and select the type of scanning. You can add up to 100 URLs at time.
...
. From the Working Environments Configuration page, click *Add Data Source* > *Add SharePoint Account*.
+
image:screenshot_compliance_add_onedrive_button.png[A screenshot of the Scan Configuration page where you can click the Add SharePoint button.]

. In the Add a SharePoint Account dialog, click *Sign in to SharePoint*.
...
You can add individual SharePoint sites, or all of your SharePoint sites, so that the associated files will be scanned by Cloud Data Sense.
...
+
image:screenshot_compliance_onedrive_add_initial_users.png[A screenshot showing the Add your first SharePoint sites button to add initial sites to be scanned.]
+
If you are adding additional users from a SharePoint account, click *Add SharePoint Sites*.
+
image:screenshot_compliance_onedrive_add_more_users.png[A screenshot showing the Add SharePoint sites button to add more sites to an account.]
...
+
image:screenshot_compliance_onedrive_add_email_addresses.png[A screenshot of the Add SharePoint Sites page where you can add sites to be scanned.]
+
...
image:screenshot_compliance_onedrive_remove_user.png[A screenshot showing how to remove a single SharePoint site from having their files scanned.]
