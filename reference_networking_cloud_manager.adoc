...
When you install the Connector using the online installer, the following ports are used on the host for internal components:
...
These ports are not used for inbound or outbound communication.
