...
Capacity-based licensing is available in the form of a _package_. When you deploy a Cloud Volumes ONTAP system, you can choose from the Essentials or Professional packages.
...
The Essentials and Professional packages are available using the following consumption options:
...
* If you purchase a license from NetApp, you should subscribe to the PAYGO offering from your cloud provider's marketplace. If you exceed your licensed capacity, this ensures that you can pay for overages.
...
With capacity-based licensing, each individual Cloud Volumes ONTAP system supports up to 2 PiB of capacity through disks and tiering to object storage.
...
Node-based licensing is the previous generation licensing model that enabled you to license Cloud Volumes ONTAP by node.

This licensing model is not available for new customers. It has been replaced with the by-capacity charging methods described above.
