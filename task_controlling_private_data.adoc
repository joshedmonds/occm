...
* You can assign a certain Status to the file. See link:task-org-private-data.html#applying-status-tags-to-manage-your-scanned-files[Applying Status tags] for details.
...
** File Owner
** Label
** Working Environment Type (note that OneDrive and SharePoint are categorized under "Cloud Apps")
