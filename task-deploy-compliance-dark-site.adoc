...
If you don't already have a Connector installed at your dark site, link:task_installing_linux.html[deploy the Connector on-premises^] on an existing Linux host in your network.
