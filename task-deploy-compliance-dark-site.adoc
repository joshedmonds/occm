...
For very large configurations where you'll be scanning petabytes of data, you can include additional hosts to provide additional processing power. link:task-deploy-compliance-dark-site.html#deploy-data-sense-on-a-multiple-hosts-large-configurations[See those steps here].
