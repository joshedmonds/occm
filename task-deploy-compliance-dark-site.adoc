...
* Docker Compose version xx or later. https://docs.docker.com/compose/install/[View installation instructions^].

* Python 3 version xx or later. https://www.python.org/downloads/[View installation instructions^].
...
* Verify that you have installed the three required software packages (Docker Engine, Docker Compose, Python 3).
...
. Launch Cloud Manager and click *Data Sense*.
