...
. On an internet-configured system, download the Cloud Data Sense software from the https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/[NetApp Support Site^]. The file you should select is named *<version>_darksite_installer_bundle.tar.gz*.
...
+
`tar -xzf 53.6.0_darksite_installer_bundle.tar.gz`
+
This extracts required software and the actual installer file *cc_onprem_installer.tar.gz*.
