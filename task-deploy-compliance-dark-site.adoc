...
summary: Complete a few steps to deploy Cloud Data Sense on a host in a dark site.
---

= Deploy Cloud Data Sense in a dark site
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Complete a few steps to deploy Cloud Data Sense on a host in a dark site.

When installed in a dark site, Data Sense can only scan data from data sources that are also local to the dark site. At this time this includes: 
...
If you don't already have a Connector installed at your dark site, link:task_installing_linux.html[deploy the Connector on-premises^] on an existing Linux host in your dark site.
...
If you don't already have a Connector, link:task_installing_linux.html[deploy the Connector on-premises^] on an existing Linux host in your network.
...
== Deploying Cloud Data Sense on premises
...
You can also link:task_licensing_datasense.html[set up BYOL licensing for Cloud Data Sense] at this time. You will not be charged until the amount of data exceeds 1 TB.
