...
* You should have created an Azure NetApp Files working environment in Cloud Manager to create and manage NetApp accounts, capacity pools, volumes, and snapshots. link:task_manage_anf.html[Learn more]
...
. If you have link:prerequisites-create-azure-connector.html#firewall-configuration[configured firewall], create a custom role using the link:media/SnapCenter_Deployment_Role3.json[SnapCenter_Deployment_Role3.json] file.
+
