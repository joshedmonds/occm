...
Existing Connector::
Adding new AWS credentials to an existing Connector enables you to deploy Cloud Volumes ONTAP in another AWS account using the same Connector.
+
Learn how to add AWS credentials to a Connector.

Directly to Cloud Manager::
...
+
Learn how to add AWS credentials to Cloud Manager.
...
=== Add the credentials to a Connector
...
== Add AWS credentials to Cloud Manager
...
=== Add the credentials to Cloud Manager
...
== Associate an AWS subscription to credentials
