...
* *Retrieval time*: The time to retrieve the archived backup file from Azure Archive and place it in Cool storage. The retrieval time is different depending on the restore priority you choose:
** *High*: < 1 hour
** *Standard*: < 15 hours
...
+
For more information about Azure Archive retrieval options, refer to https://azure.microsoft.com/en-us/pricing/details/storage/blobs/#faq[this FAQ].
