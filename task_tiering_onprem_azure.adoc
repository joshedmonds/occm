...
* An on-prem ONTAP cluster that's running ONTAP 9.4 or later and has an HTTPS connection to Azure Blob storage. link:task_discovering_ontap.html[Learn how to discover a cluster].
...
The Blob container must be in a link:reference_azure_support.html#supported-azure-regions[region that supports Cloud Tiering].
