...
Both NVE and NAE are supported with an external key manager. If you use NVE, you also have the option to use Azure Key Vault (AKV) or the Google Cloud Key Management Service to protect ONTAP encryption keys.
