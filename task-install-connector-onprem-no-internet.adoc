...
summary: You can install the Connector on an on-premises Linux host that doesn't have internet access, and then discover on-prem ONTAP clusters and scan them with Cloud Data Sense.
---
...
[.lead]
You can install the Connector on an on-premises Linux host that doesn't have internet access, and then discover on-prem ONTAP clusters and scan them with Cloud Data Sense.
...
Docker Engine:: Docker Engine is required on the host before you install the Connector. https://docs.docker.com/engine/install/[View installation instructions^].
...
* Root privileges aren't required to install the Connector.
