...
This page describes how to create a Connector in AWS directly from Cloud Manager. link:concept_connectors.html[Learn about other ways to deploy a Connector].
