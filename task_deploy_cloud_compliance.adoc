...
You can also link:task_licensing_datasense.html[set up licensing for Cloud Data Sense] at this time. You will not be charged until the amount of data exceeds 1 TB. A subscription to the AWS or Azure Marketplace can be used when you have deployed Data Sense on an on-premises system.
// GCP
