...
link:task_sync_copying_acls.html[Learn how to copy ACLs between SMB shares].
...
Then you can consider accelerating sync performance by adding an additional data brokers to a group to share the load of that relationship. link:task_sync_managing_relationships.html#accelerating-sync-performance[Learn how to accelerate sync performance].
