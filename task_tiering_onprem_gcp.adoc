...
* An on-prem ONTAP cluster that's running ONTAP 9.6 or later and has an HTTPS connection to Google Cloud Storage. link:task_discovering_ontap.html[Learn how to discover a cluster].
...
The Cloud Storage buckets must be in a link:reference_google_support.html#supported-google-cloud-regions[region that supports Cloud Tiering].
